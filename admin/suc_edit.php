...
<div class='card'>
    ...
    <h1>Success</h1>
    <p>Information UPDATED Successfully!;<br/>Kindly Verify in the Home page.</p>
    <div class='modal-buttons'>
        <button onclick='window.location.href=\"edit_services.php\"'>Edit Another Another</button>
