    ...
    <header>
        ...
        <div class="hamburger" onclick="toggleMenu()">☰</div>
            ...
            <li><a href="#home">HOME</a></li>
                ...
                <button onclick="window.location.href='#service'">Book Service</button>
...
<script>
    ...
    // Function to logout
    function logout() {
        // Redirect to main.php after clicking "Yes"
        window.location.href = "main.php"; // Redirects the user to main.php
    ...
    function cancelLogout() {
        modal.style.display = "none"; // Close the modal without logging out
    }
