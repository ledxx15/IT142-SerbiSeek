...
// Fetch previous bookings with ratings
$query = "
    SELECT 
        b.id AS booking_id, 
        b.status, 
                    ...
                    <tr>
                            ...
                            <?php 
                                switch ($booking['status']) {
                                    case 'Pending': 
                                        ...
                                        break;
                                    case 'Booked': 
                                        echo "<span style='color: blue;'>Booked</span>"; 
                                        break;
                                    case 'Accepted': 
                        ...
                        <td>
                            <?php if ($booking['rating'] != NULL): ?>
                                <span class="view-rating">Rating: <?php echo $booking['rating']; ?></span>
                                <br>
                                <span>Review: <?php echo $booking['review']; ?></span>
                            <?php else: ?>
                                <span class="no-rating">No Rating</span>
                            <?php endif; ?>
                        </td>
                        <td>
                            <?php if ($booking['status'] == 'Finished' && $booking['rating'] == NULL): ?>
                                <form method="POST" action="rate_service.php">
                                    <input type="hidden" name="booking_id" value="<?php echo $booking['booking_id']; ?>">
                                    <button type="submit" class="rate-button">Rate Service</button>
                                </form>
                            <?php else: ?>
                                <span>N/A</span>
                            <?php endif; ?>
